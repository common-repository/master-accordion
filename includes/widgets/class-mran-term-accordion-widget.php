 ...
 */
class MRAN_Term_Accordion_Widgets extends WP_Widget {
	...
	public function __construct() {
		$widget_ops  = array(
			'classname'                   => 'mran_term_accordion_widget',
			'description'                 => esc_html__( 'Widget for Term Accordion', 'master-accordion' ),
			'customize_selective_refresh' => true,
		);
		$control_ops = array( 'width' => 350, 'height' => 350 );
		parent::__construct( 'mran_term_accordion_widget', esc_html__( 'Accordion Term Widget', 'master-accordion' ), $widget_ops, $control_ops );
	}
						...
						foreach ( $all_terms as $key => $term_detail ):
							...
							<li class="mran-accordion-item-wrap">
								<div class="mran-accordion-title <?php echo esc_attr($active_class); ?>" style="background:<?php echo sanitize_hex_color($title_background); ?>; color:<?php echo sanitize_hex_color($title_color); ?>;">
									<span data-href="#mran_<?php echo $term_detail->slug.$term_detail->term_id; ?>"><?php echo $term_detail->name; ?></span>
								...
								<div class="mran-content <?php echo esc_attr($active_class); ?>" id="mran_<?php echo $term_detail->slug.$term_detail->term_id; ?>" style="background:<?php echo sanitize_hex_color($content_background); ?>; color:<?php echo sanitize_hex_color($content_color); ?>; <?php echo esc_attr($active_style); ?>">
...
register_widget( 'MRAN_Term_Accordion_Widgets' );