...
class Master_Accordion_Loader {
    ...
    function mran_template_part($templateFile){


        if ( $overridden_template = locate_template( DIRECTORY_SEPARATOR.'master-accordion'.DIRECTORY_SEPARATOR.$templateFile ) ) {
